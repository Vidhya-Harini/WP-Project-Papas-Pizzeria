...
<head>
   ...
   <title>Register Now | Papa's Pizzeria</title>
...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>Join Papa's Pizzeria Family</h3>
      ...
      <p style="color: var(--black);">Already have an account? <a href="login.php" style="color: #f59f27;">Login Here</a></p>
   </form>
