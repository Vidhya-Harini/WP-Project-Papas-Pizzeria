...
<section class="products">
   ...
   <div class="box-container">
      ...
      <form action="" method="post" class="box" style="border: .2rem solid var(--brown);">
         ...
         <a href="quick_view.php?pid=<?= $fetch_cart['pid']; ?>" class="fas fa-eye" style="color:var(--white);"></a>
         ...
         <div class="flex">
            ...
            <button type="submit" class="fas fa-edit" name="update_qty" style="color: var(--black);"></button>
         </div>
